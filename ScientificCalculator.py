    ...
    while True:
        try:
            ...
            if s_num >= 0:   
                ...
                print(f'Square root of {s_num} is {result_square_root}')
                History.add_history(
...
def cube_root():
    while True:
        try:
            ...
            print(f'Cube root of {c_num} is {result_cube_root}') 
            History.add_history(
...
def sin_func(): 
    while True: 
        try:
            ...
            print(f'sin({degree_numbr}°) = {sin_result}')
...
def cos_func(): 
    while True: 
        try:
            ...
            print(f'cos({degree_numbr}°) = {cos_result}')
            History.add_history(
            	f'cos({degree_numbr}°) ',
            	cos_result
            )
...
def tan_func(): 
    while True: 
        try:
            ...
            print(f'tan({degree_numbr}°) = {tan_result}')
            History.add_history(
            	f'tan({degree_numbr}°) ',
            	tan_result
            )
    ...
    while True:
        try:
            ...
            if l_num > 0:   
                ...
                print(f'log10({l_num}) = {result_log10}')
                print(f'ln({l_num}) = {result_log}')
                History.add_history(
                	f'log10({l_num}) ',
                	result_log10
                )
    ...
    while True:
        try:
            ...
            if f_num >= 0:   
                ...
                print(f'({f_num})! = {result_factorial}')
                History.add_history(
                	f'({f_num})! ',
                	result_factorial
                )
    ...
    while True: 
        try:
            ...
            if -1 <= num <= 1:
                ...
                print(f'arcsin({num}) = {degree_result}°')
                History.add_history(
                	f'arcsin({num}) ',
                	degree_result
                )
    ...
    while True: 
        try:
            ...
            if -1 <= num <= 1:
                ...
                degree_result = math.degrees(radian_result)
                print(f'arccos({num}) = {degree_result}°')
                History.add_history(
                	f'arccos({num}) ',
                	degree_result
                )
...
def atan_func(): 
    while True: 
        try:
            ...
            degree_result = math.degrees(radian_result)
            print(f'arctan({num}) = {degree_result}°')
            History.add_history(
            	f'arctan({num}) ',
            	degree_result
            )
